    ...
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4 flex flex-col items-start">
        ...
        <li>
          ...
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Kiran V Gowda: 9902950380</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Arun Sharma: 9738425496</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>For customer support:</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Call: 9380078320</p>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4 flex flex-col items-start">
        ...
        <nav class="list-none flex flex-col items-start mb-10">
        <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Front Office</p>
          </li> 
          <li>
          ...
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>HR Management</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Door Locking System</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Supermarket & Retail</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>MRP Billing Software</p>
          </li>
          <li>
            <p class="text-gray-600 text-xs hover:text-gray-800" style={{margin:"2px"}}>Bar Retail Software</p>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4 flex flex-col items-start">
